...
Priority Order:
1. Question count (who asks >60% of questions)
2. Host-specific phrases (welcome, thanks for joining, hope you enjoyed)
3. YouTube CTAs (subscribe, like, bell)
...
# YouTube-specific host indicators
...
def detect_host_segments(segments):
    ...
    for i, seg in enumerate(segments):
        ...
        # Check host-specific phrases first (highest priority)
    ...
    # Return highest priority group found
    if host_phrase_segs:
