...
'''
python src/diarizze_whisperx_gpu.py data/raw_audio/ep_002.wav --output_dir data/outputs/whisperx   --model large-v2   --batch_size 16   --hf_token "$HF_TOKEN"   --language en
