...
Usage:
    python src/detect_gender_v4.py \
        --audio data/raw_audio/ep_005.wav \
        --input_json data/outputs/whisperx/ep_005_whisperx_diarized.json \
        --output_json data/outputs/whisperx/ep_005_whisperx_diarized.gender.json \
        --output_txt data/outputs/whisperx/ep_005_whisperx_diarized.gender.txt \
...
def main():
    ...
    ap.add_argument("--match_threshold", type=float, default=0.80,
                    help="Cosine similarity threshold for a library match (default: 0.80)")
