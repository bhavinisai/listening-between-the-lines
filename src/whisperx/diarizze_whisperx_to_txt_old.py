...
Prereqs (once):
  pip install -U whisperx torch torchvision torchaudio
  # plus a Hugging Face token with access to pyannote diarization models:
  export HF_TOKEN="hf_..."

Run:
  python whisperx_speaker_transcribe.py --audio path/to/clip.wav --outdir outputs --model medium --compute_type int8 --language en
...
def main():
    ...
    diarization_segments = diarize_pipeline(
